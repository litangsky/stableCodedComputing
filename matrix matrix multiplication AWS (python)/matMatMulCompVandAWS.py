# -*- coding: utf-8 -*-
##########################################################################################
# Code for complex Vandemonde method (complex polynomial codes) in AWS
...
from matMatMulAWS import pickWorkers, transmitStragglersInfo, randMatGenerator, getCompVandEncodingMatOfA, getCompVandEncodingMatOfB, getEncodingMat, encodeMat, threadSleep, sendRstToMaster
...
if comm.rank == 0:
    ...
    matOfAFromMaster = receiveMatrixOfAFromMaster(comm, (t, bA), np.complex128)
    matOfBFromMaster = receiveMatrixOfBFromMaster(comm, (t, bB), np.complex128)
