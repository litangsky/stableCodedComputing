# -*- coding: utf-8 -*-
########################################################################################################
# Code for Fahim-Cadambe codes method
...
from matMatMul import addGaussianNoise, getVVEncodingMatOfA, getVVEncodingMatOfB, getEncodingMat, randMatGenerator, getMultResult, encodeMat, pickWorkers, transmitSubMat2Workers, computeWorker, reshapeReceivedInfo, decodeResult, getMSE, findWorkerSet2WorstCond

#########################################################
#matrix A (dim t*(sA*q*kA)) and matrix B (dim t*(sA*q*kA))
