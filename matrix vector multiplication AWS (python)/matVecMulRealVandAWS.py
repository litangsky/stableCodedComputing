...
##########################################################################################
from matVecMulAWS import genRandMat, pickWorkers, getRealVandEncodingMat, encodeMat, getMultResult, getMSE
...
if comm.rank == 0:
    ...
    matFromMaster = receiveMatrixFromMaster(comm, (t, b), np.float64)
