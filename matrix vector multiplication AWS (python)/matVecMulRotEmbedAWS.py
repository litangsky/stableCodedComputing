# -*- coding: utf-8 -*-
##########################################################################################
# Code for Vandermonde embeded by rotation matrix method
...
from matVecMulAWS import genRandMat, pickWorkers, getRotEmbedEncodingMat, encodeMat, getMultResult, getMSE
