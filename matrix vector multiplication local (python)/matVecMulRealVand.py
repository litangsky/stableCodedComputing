# -*- coding: utf-8 -*-
##########################################################################################
# Code for real Vandemonde method
...
from matVecMul import addGaussianNoise, getRealVandEncodingMat, genRandMat, getMultResult, encodeMat, pickWorkers, transmitSubMat2Workers, computeWorker, decodeResult, getMSE, findWorkerSet2WorstCond
import numpy as np

#########################################################
#matrix A (dim t*(b*k)) and vector x (dim t)
...
#########################################################
#########################################################
print("Matrix-vector multiplication: Real Vandemonde method")
...
G = getRealVandEncodingMat(k, n)

# Create random matrices and vector 
A = genRandMat(-50, 50, [t, k*b])
